...
export default function MapGoogle( props : MapGoogleProps ) : JSX.Element
{
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////
    function asyncMap( google : any ) : void
    {
        ...
        const request : google.maps.DirectionsRequest = {
                                ...
                                origin: "4 Deer Trail Ct, Gaithersburg, MD",
                                destination: "7920 Jones Branch Dr, McLean, VA",
    ...
    // ===============================================================================================
    return (
        <div id={"map"} style={ { width: "100%", height: props.config.height } } ></div>      
    );
    // ===============================================================================================
}
